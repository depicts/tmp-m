...
impl ApiClient {
    pub fn new(url: String, address: String, chain: String, wallet: String) -> ApiClient {
        ApiClient { url, address, chain, wallet }
    }
    ...
    pub fn get(&self, path: String) -> reqwest::RequestBuilder {
        ...
        client
            ...
            .header("Chain", self.chain.clone())
            .header("Wallet", self.wallet.clone())
    }
